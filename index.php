...
<?php include"includes/meta.php";?>
    ...
    <body id="top">
        ...
        <section class="hero-section d-flex justify-content-center align-items-center" id="tech_services_hero">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-12">
                <h1 class="text-white">Transforming Tech Dreams into Reality</h1>
                <p class="text-white">Your Trusted Partner for Cutting-Edge Tech Solutions</p>
                <a href="#contact" class="btn btn-primary">Get Started</a>
            </div>
            <div class="col-lg-6 col-12">
                <img src="your-image.jpg" alt="Tech Services Image" class="img-fluid">
            </div>
        </div>
    </div>
</section>
